          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/jonathan-trovato-7b063b203/"><img src={navIcon1} alt="" /></a>
                <a href="https://github.com/Trovato1"><img src={navIcon2} alt="" /></a>
                <a href="https://wa.me/+5532991283984"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
